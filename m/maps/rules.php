<?php
	...
	return array(
		'pages' => array(
			'fields' => array('id_parent', 'url', 'full_cache_url', 'title_in_menu', 'title', 'keywords', 'description', 'content', 'id_base_template', 'id_template', 'is_show', 'id_menu'), // поля, чтобы выкинуть из массива $_POST лишние элементы
		...
		'images' => array(
			'fields' => array('path', 'title_image', 'alt', 'href', 'is_show'), 
		...
		'i18n' => array(
			'fields' => array('id_i18n', 'id_lang', 'id_article', 'id_page', 'id_text', 'id_image', 'title', 'title_image', 'content', 
							  'alt', 'href', 'title_in_menu', 'keywords', 'description', 'is_show'), 
			'not_empty' => array('id_i18n', 'id_lang'),
			'html_allowed' => array('id_i18n', 'id_lang', 'id_article', 'id_page', 'id_text', 'id_image', 'title', 'title_image', 'content', 
							  'alt', 'href', 'title_in_menu', 'keywords', 'description', 'is_show'),
			'unique' => array(),
			'not_url' => array(),
			'range' => array(),
			'labels' => array(
				// не нужны, так как валидация идёт в основных моделях
			),
			'pk' => 'id_i18n'
		),
	);
